...
function buildPassportSystemPrompt() {
  return joinNonEmpty([
    ...
    "9) Верни строго JSON, соответствующий schema reference.",
    PASSPORT_REFERENCE
  ]);
}
...
function buildRegenerationSystemPrompt() {
  return joinNonEmpty([
    ...
    "5) Верни только полный JSON в той же схеме."
  ]);
}
...
function fallbackPassportV2(input, kernel, chosenName) {
  return {
    ...
    validation_plan: [
      { name: "[ПРЕДПОЛОЖЕНИЕ] Sensory test", hypothesis: "[ПРЕДПОЛОЖЕНИЕ]", method: "[ПРЕДПОЛОЖЕНИЕ]", kpi: "[ПРЕДПОЛОЖЕНИЕ]", threshold: "[ПРЕДПОЛОЖЕНИЕ]", duration_days: 14, budget_rub: "[ПРЕДПОЛОЖЕНИЕ]" },
      ...
      { name: "[ПРЕДПОЛОЖЕНИЕ] Pilot", hypothesis: "[ПРЕДПОЛОЖЕНИЕ]", method: "[ПРЕДПОЛОЖЕНИЕ]", kpi: "[ПРЕДПОЛОЖЕНИЕ]", threshold: "[ПРЕДПОЛОЖЕНИЕ]", duration_days: 30, budget_rub: "[ПРЕДПОЛОЖЕНИЕ]" },
      { name: "[ПРЕДПОЛОЖЕНИЕ] A/B landing", hypothesis: "[ПРЕДПОЛОЖЕНИЕ]", method: "[ПРЕДПОЛОЖЕНИЕ]", kpi: "[ПРЕДПОЛОЖЕНИЕ]", threshold: "[ПРЕДПОЛОЖЕНИЕ]", duration_days: 14, budget_rub: "[ПРЕДПОЛОЖЕНИЕ]" }
    ],
    risks: [
